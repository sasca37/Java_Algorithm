...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!queue.isEmpty() && cnt++ < 10) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int k = 0; k < 4; k++) {
                    Point r = new Point(tmp[0].x, tmp[0].y, tmp[0].orders + dz[k]);
                    Point b = new Point(tmp[1].x, tmp[1].y, tmp[0].orders + dz[k]);
                    ...
                    if (board[r.x][r.y] == 'O') {
                        ...
                        System.out.println(tmp[0].orders+dz[k]);
                        return;
                    }
    ...
    static class Point {
        ...
        public Point(int x, int y, String orders) {
            this.x = x;
            this.y = y;
            this.orders = orders;
        }
